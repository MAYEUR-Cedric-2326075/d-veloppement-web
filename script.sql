...
CREATE TABLE `Tenrac` (
                          `mail_tenrac` VARCHAR(255) PRIMARY KEY NOT NULL,
...
CREATE TABLE `Sex` (
                       `libel_sex` VARCHAR(255) PRIMARY KEY NOT NULL
);

CREATE TABLE `Title` (
                         `id_title` INT PRIMARY KEY AUTO_INCREMENT NOT NULL
);
...
CREATE TABLE `Dignity` (
                           `id_dignity` INT PRIMARY KEY AUTO_INCREMENT NOT NULL
);

CREATE TABLE `DignitySex` (
                              `id_dignity` INT NOT NULL,
                              `libel_sex` VARCHAR(255) NOT NULL,
                              `libel_dignite_sex` VARCHAR(255) NOT NULL,
                              PRIMARY KEY (`id_dignity`, `libel_sex`)
);

CREATE TABLE `Rank` (
                        `id_rank` INT PRIMARY KEY AUTO_INCREMENT NOT NULL
);

CREATE TABLE `RankSex` (
                           `libel_sex` VARCHAR(255) NOT NULL,
                           `id_rank` INT NOT NULL,
                           `libel_rang_sex` VARCHAR(255) NOT NULL,
...
CREATE TABLE `GradeSex` (
                            `libel_sex` VARCHAR(255) NOT NULL,
                            `id_grade` INT NOT NULL,
                            `libelRangSex` VARCHAR(255) NOT NULL,
...
CREATE TABLE `Meal` (
                        `id_meal` INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
                        `dat` DATE NOT NULL,
...
CREATE TABLE `TenracMeal` (
                              `mail_tenrac` VARCHAR(255) NOT NULL,
...
CREATE TABLE `Dish` (
                        `id_dish` INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
                        `libel_dish` VARCHAR(255) NOT NULL
);

CREATE TABLE `Sauce` (
                         `id_sauce` INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
                         `libel_sauce` VARCHAR(255) NOT NULL
);
...
CREATE TABLE `Ingredient` (
                              ...
                              `libel_ingredient` VARCHAR(255) NOT NULL
);
